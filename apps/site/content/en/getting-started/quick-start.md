...
This guide walks you through the developer workflow after your team has deployed Jex. If you do not have an API URL yet, start with [Self-Host First](/en/docs/getting-started/self-host-first).
...
This opens your browser to your team's Jex login page. After authenticating, a token is
