...
const docsCopy = {
  en: {
    title: "Jex Docs",
    intro: "Documentation for self-hosting Jex, managing secrets, and using the CLI.",
    home: "Home",
    switchLocale: "FR",
    nav: [
      { href: "/docs", label: "Introduction" },
      { href: "/docs/why-self-host", label: "Why self-host" },
      {
        href: "/docs/getting-started/self-host-first",
        label: "Getting Started",
        children: [
          { href: "/docs/getting-started/self-host-first", label: "Self-host first" },
  ...
  fr: {
    ...
    intro: "Documentation pour auto-héberger Jex, gérer les secrets et utiliser la CLI.",
    home: "Accueil",
    switchLocale: "EN",
    nav: [
      { href: "/docs", label: "Introduction" },
      { href: "/docs/why-self-host", label: "Pourquoi auto-héberger" },
      {
        href: "/docs/getting-started/self-host-first",
        label: "Premiers pas",
        children: [
          { href: "/docs/getting-started/self-host-first", label: "Auto-hébergement d'abord" },
          { href: "/docs/getting-started/installation", label: "Installation" },
