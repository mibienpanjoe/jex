...
Ce guide couvre le workflow développeur complet en moins de cinq minutes.
...
Cette commande ouvre votre navigateur sur la page de connexion Jex. Après authentification, un token est enregistré dans `~/.jex/token` avec les permissions `0600`. Vous n'avez besoin de le faire qu'une seule fois par machine.
